...
- Phase-3 increment delivered: subscription settings entry point with HTTPS-validated billing portal URL launch and copy-url support for operator self-service and troubleshooting.
