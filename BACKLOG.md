...
- [x] Business Rewards campaign operations now include one-tap diagnostics clipboard export (active filters, KPI summaries, channel-distribution summary, snapshot timestamp, visible-campaign preview, localized copy-status feedback) for faster support handoff and troubleshooting.
