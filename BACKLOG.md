...
- [x] Business Rewards campaign operations now include one-tap diagnostics clipboard export (active filters, KPI summaries, snapshot timestamp, localized copy-status feedback) for faster support handoff and troubleshooting.
