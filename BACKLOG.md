...
- [x] Business Settings subscription flow now includes environment diagnostics (missing/invalid/non-HTTPS/host-allowlist), secure portal launch, and copy-url support to speed operator troubleshooting.
