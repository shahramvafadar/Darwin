...
- [~] Business subscription management (Stripe) — mobile settings entry point + read-only subscription status snapshot + cancel-at-period-end toggle + available-plans listing delivered; upgrade/checkout workflow pending.
