...
namespace Darwin.Application.Identity.Queries
{
    ...
    public sealed class GetUsersPageHandler
    {
            ...
            int page, int pageSize, string? emailFilter, UserQueueFilter filter = UserQueueFilter.All, CancellationToken ct = default)
        {
            ...
            q = filter switch
            {
                ...
                UserQueueFilter.MobileLinked => q.Where(u => _db.Set<Darwin.Domain.Entities.Identity.UserDevice>().Any(d => d.UserId == u.Id && d.IsActive)),
                _ => q
            };
            ...
            var items = await q.OrderBy(u => u.Email)
                ...
                .Select(u => new UserListItemDto
                {
                    ...
                    MobileDeviceCount = _db.Set<Darwin.Domain.Entities.Identity.UserDevice>().Count(d => d.UserId == u.Id && d.IsActive),
    ...
    public sealed class GetUserOpsSummaryHandler
    {
        ...
        {
            var users = _db.Set<Darwin.Domain.Entities.Identity.User>().AsNoTracking();
            ...
            return new UserOpsSummaryDto
            {
                ...
                MobileLinkedCount = await users.CountAsync(u => _db.Set<Darwin.Domain.Entities.Identity.UserDevice>().Any(d => d.UserId == u.Id && d.IsActive), ct).ConfigureAwait(false)
            };
        }
    }
}
