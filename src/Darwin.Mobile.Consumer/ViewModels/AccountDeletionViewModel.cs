...
/// <summary>
/// Shows a warning-first account deletion handoff flow for the Consumer app.
/// </summary>
public sealed class AccountDeletionViewModel : BaseViewModel
{
    ...
    /// <summary>
    /// Gets the command that opens the external deletion page after the in-app warning step.
    /// </summary>
