...
public static class AppResources
{
    ...
    public static string AccountDeletionWarningBody => ResourceManager.GetString(nameof(AccountDeletionWarningBody), Culture) ?? "Account deletion is completed on the external Loyan website. Review the information carefully before continuing.";
